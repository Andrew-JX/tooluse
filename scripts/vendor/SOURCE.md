...
| 取回日期 | 2026-08-26 |
| 许可证 | Apache-2.0 — Copyright 2026 Anthropic, PBC，全文见 [../../licenses/LICENSE-anthropics-skills.txt](../../licenses/LICENSE-anthropics-skills.txt) |

收它的理由：`self-check.sh` 第 ② 条要跑官方 validator，而 CI 机器上没有 skill-creator，
那一步一直显示「未找到，跳过」——**一条只在作者本机生效的门禁等于没有门禁**。

**改动一律提到上游。** 上游改了不影响这份副本——这是提示词文本，不是会失效的代码。
